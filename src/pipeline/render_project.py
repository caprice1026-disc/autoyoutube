...
from src.pipeline.render_metadata import (
    build_bgm_render as _build_bgm_render,
    build_credits as _build_credits,
    build_description as _build_description,
    build_subtitle as _build_subtitle,
    wrap_subtitle_text as _wrap_subtitle_text,
)
